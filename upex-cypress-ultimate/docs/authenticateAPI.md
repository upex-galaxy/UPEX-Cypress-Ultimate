...
Del lado del servidor hay dos secretos definidos:

- TRELLO_KEY
- TRELLO_TOKEN

Crea un archivo .env en el root del repositorio con estos datos para tus pruebas locales.
Si experimentas problemas para agregar miembros a un tablero usando su idUser prueba con su email.
