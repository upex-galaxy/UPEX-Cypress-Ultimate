describe('US GX3-5565 | ToolsQA | Elements | Buttons', () => {
	beforeEach('PRC: Abrir la url buttons de ToolsQA. @smoke', () => {
		cy.visit('https://demoqa.com/buttons');
		cy.url().should('contain', 'buttons');
	});

	it('US # GX3-5565 | TC#01: Validar comportamiento del button "DOUBLE Click" al hacer dblClick @HP', () => {
	...
	it('US # GX3-5565 | TC#02: Validar comportamiento del button "RIGHT Click" al hacer rightClick @HP', () => {
	...
	it('US # GX3-5565 | TC#03: Validar comportamiento del button "CLICK" al hacer click @HP', () => {
