import { objCheckboxTree } from '@pages/DemoQA/GX3-5646-Checkbox.Page';

describe('US # GX3-5646 | ToolsQA | Elements | Checkbox', () => {
	beforeEach('PRC: Abrir url de Checkbox en ToolsQA. @smoke', () => {
		cy.visit('https://demoqa.com/checkbox');
		cy.url().should('contain', 'checkbox');
	});

	it('GX3-5661 | TC#01: Validar que el boton "Expand All" abra todas las ramas @HP', () => {
	...
	it('GX3-5661 | TC#02: Validar que el boton "Collapse All" cierre todas las ramas @HP', () => {
		const BUTTON_EXPAND_ALL = objCheckboxTree.getSelector.buttonExpandAll();
	...
	it('GX3-5661 | TC#05: Validar que al marcar un checkbox contenedor se seleccionen los subelementos y se muestre el texto de la selección correctamente @HP', () => {
		const BUTTON_EXPAND_ALL = objCheckboxTree.getSelector.buttonExpandAll();
