...
import { objJsonDataHandler } from '@utils/JsonDataHandler';
import { objPracticeFormPage } from '@pages/DemoQA/GX3-5746-Practice-Form.Page';
...
describe('GX3-5746 |ToolsQA | Forms | Practice Form', () => {
	beforeEach('PRC: Usuario debe estar en la url Practice Form de ToolsQA. @smoke', () => {
