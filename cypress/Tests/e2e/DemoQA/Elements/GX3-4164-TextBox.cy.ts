import Data from '@data/DemoQA/Elements/GX3-4164-TextBox.json';

describe('GX3 4164 ToolsQA | Elements | Text Box: Fill form and Submit', () => {
	//vistar la pagina demo QA
	beforeEach('PRD: El usuario debe visitar la Pagina Demo QA. @smoke', () => {
		cy.visit('https://demoqa.com/text-box');
		cy.url().should('contain', 'text-box');
	});

	it('4165 | TC1: Validar el registro exitoso cuando se ingresa un emails valido. @HP', () => {
